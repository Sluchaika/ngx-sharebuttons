 ...
 */
var noneOperator = map(function (ref) { return ref.prop.share[ref.os] + ref.url; });
/**
 * Meta tags operator - Serialize meta tags in the sharer URL
 */
var metaTagsOperator = map(function (ref) {
    /**
 ...
 */
var printOperator = map(function (ref) { return ref.window.print(); });
/**
 ...
 */
var pinterestOperator = map(function (url) {
...
var ShareButtonDirective = (function () {
    ...
    ShareButtonDirective.prototype.onClick = function () {
        ...
        /** Share the link */
        (_a = of$1(ref)).pipe.apply(_a, this.prop.share.operators.concat([tap(function (sharerURL) { return _this.share(sharerURL); }), take(1)])).subscribe();
        var _a;
    };
    /**
     * Emit share count
    ...
    ShareButtonDirective.prototype.count = function (url) {
        if (this.prop.count.request === 'jsonp') {
            return (_a = this.http.jsonp(this.prop.count.url + url, 'callback')).pipe.apply(_a, this.prop.count.operators.concat([catchError(function () { return empty$1(); })]));
        }
        else {
            return (_b = this.http.get(this.prop.count.url + url, this.prop.count.args)).pipe.apply(_b, this.prop.count.operators.concat([catchError(function () { return empty$1(); })]));
        }
        var _a, _b;
    };
    /**
